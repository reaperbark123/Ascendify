...
do -- //UI Stuff
    do--// Library Functions
        ...
        Library = {
            ...
            AccentColor = MyAccent or Color3.fromRGB(0, 85, 255);
            OutlineColor = Color3.fromRGB(50, 50, 50);
            RiskColor = Color3.fromRGB(255, 50, 50);

            ColorsToSet = {
                Accent = Color3.fromRGB(255, 0, 234);
            };

            Accents = {
                CustomAccent = Color3.fromRGB(242, 176, 255);
                Accent2 = Color3.fromRGB(93, 121, 255);
            };
        ...
        function Library:MakeDraggable(Instance, Cutoff)
            ...
            Instance.InputBegan:Connect(function(Input, typing)
                if typing then return end;
                if (Input.UserInputType == Enum.UserInputType.MouseButton1 and not LockedTheUI) or (Input.UserInputType == Enum.UserInputType.Touch and not LockedTheUI) then
                    ...
                    while InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) do
        ...
        do
            ...
            function Funcs:AddColorPicker(Idx, Info)
                ...
                do
                    ...
                    function ContextMenu:AddOption(Str, Callback)
                        ...
                        Button.InputBegan:Connect(function(Input, typing)
                            if typing then return end;
                ...
                SatVibMap.InputBegan:Connect(function(Input, typing)
                    if typing then return end;
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                        while InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) do
                ...
                HueSelectorInner.InputBegan:Connect(function(Input, typing)
                    if typing then return end;
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                        while InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) do
                ...
                DisplayFrame.InputBegan:Connect(function(Input, typing)
                    if typing then return end;
                ...
                if TransparencyBoxInner then
                    TransparencyBoxInner.InputBegan:Connect(function(Input, typing)
                        if typing then return end;
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                            while InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) do
            ...
            function Funcs:AddKeyPicker(Idx, Info)
                ...
                for Idx, Mode in next, Modes do
                    ...
                    Label.InputBegan:Connect(function(Input, typing)
                        if typing then return end;
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                            ModeButton:Select();
                            Library:AttemptSave();
                ...
                PickOuter.InputBegan:Connect(function(Input, typing)
                    if typing then return end;
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch and not Library:MouseIsOverOpenedFrame() then
                        Picking = true;
                        ...
                        local Event;
                        Event = InputService.InputBegan:Connect(function(Input, typing)
                            if typing then return end;
                            local Key;
        ...
        do
            ...
            function Funcs:AddButton(...)
                ...
                local function InitEvents(Button)
                    ...
                    Button.Outer.InputBegan:Connect(function(Input, typing)
                        if typing then return end;
            ...
            function Funcs:AddSlider(Idx, Info)
                ...
                SliderInner.InputBegan:Connect(function(Input, typing)
                    if typing then return end
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch and not Library:MouseIsOverOpenedFrame() then
                        local mPos = Mouse.X;
                ...
                function Dropdown:BuildDropdownList()
                    ...
                    for Idx, Value in next, Values do
                        ...
                        function Table:UpdateButton()
                            ...
                            ButtonLabel.TextColor3 =
                                Selected and Library.AccentColor or Library.FontColor

                            Library.RegistryMap[ButtonLabel].Properties.TextColor3 =
                                Selected and 'AccentColor' or 'FontColor'
                        end

                        ButtonLabel.InputBegan:Connect(function(Input, typing)
                            if typing then
                                return
                            end
                            ...
                            if Input.UserInputType == Enum.UserInputType.MouseButton1
                                ...
                                if Dropdown:GetActiveValues() == 1
                                    and not Try
                                    and not Info.AllowNull then
                                    return
                                end

                                if Info.Multi then
                                    Selected = Try
                                    Dropdown.Value[Value] = Selected
                                else
                                    Selected = Try
                        ...
                        -- Don't call Display() for every single button
                        -- Only update the dropdown after the list is finished.
                    ...
                    -- Only do this once instead of once per element
        ...
        local function GetState()
            if game:GetService("UserInputService").KeyboardEnabled or game:GetService("UserInputService").MouseEnabled then
                return 'Keyboard'
        ...
        function Library:CreateWindow(...)
            ...
            local WindowLabel = Library:CreateLabel({
                ...
                Text = Config.Game and (
                    Library.HubName .. " | <font color= \"rgb(%d, %d, %d)\">" .. Config.Game .. "</font> | <font color= \"rgb(%d, %d, %d)\">" .. Library.Vanity .. "</font>"
                        ...
                        Library.Accents.CustomAccent.B * 255,
            ...
            function Window:AddTab(Name)
                ...
                TabButton.InputBegan:Connect(function(Input, typing)
                    if typing then return end;
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                        Tab:ShowTab();
                    end;
        ...
        MobileUI = {
            Colors = {
                ...
                Accent = Library.ColorsToSet.Accent;
                Outline = Color3.fromRGB(10, 10, 10);
            };

            Registry = {};
        }
        function MobileUI:UpdateColors(accentColor, backgroundColor, mainColor, fontColor, outlineColor)
            for _, Object in ipairs(MobileUI.Registry) do
                if Object:IsA("Frame") or Object:IsA("TextButton") then
                    Object.BackgroundColor3 = mainColor
                    Object.BorderColor3 = outlineColor
                    if Object:IsA("TextButton") then
                        Object.TextColor3 = fontColor
                    end
                end
            end
            -- Update specific elements with accent color
            if Accent then
                Accent.BackgroundColor3 = accentColor
            end
            -- Add more specific updates for other elements if needed
        end
